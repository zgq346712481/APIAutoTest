...
-- 数据库: `ceshuframework`
--
CREATE DATABASE `ceshuframework` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `ceshuframework`;
...
INSERT INTO `auth_rule` (`id`, `module`, `type`, `name`, `param`, `title`, `status`, `condition`) VALUES
...
(18, 'Portal', 'admin_url', 'portal/adminterm/index', NULL, '分类列表', 1, ''),
...
(39, 'Admin', 'admin_url', 'admin/extension/default', NULL, '站点管理', 1, ''),
...
(83, 'Api', 'admin_url', 'api/oauthadmin/setting', NULL, '第三方登录', 1, ''),
...
(111, 'Admin', 'admin_url', 'admin/user/userinfo', NULL, '个人资料', 1, ''),
...
INSERT INTO `comments` (`id`, `post_table`, `post_id`, `url`, `uid`, `to_uid`, `full_name`, `email`, `createtime`, `content`, `type`, `parentid`, `path`, `status`) VALUES
(1, 'posts', 1, '', 1, 0, 'ceshu', '', '2016-11-02 10:21:10', '这里是评论内容', 1, 0, NULL, 1);
...
INSERT INTO `guestbook` (`id`, `full_name`, `email`, `title`, `msg`, `createtime`, `status`) VALUES
(1, 'test', '', '测试留言', '这里是留言内容', '2016-11-03 19:42:40', 1);
...
INSERT INTO `links` (`link_id`, `link_url`, `link_name`, `link_image`, `link_target`, `link_description`, `link_status`, `link_rating`, `link_rel`, `listorder`) VALUES
(2, '', '测试友链', 'admin/20161104/581c8cde9c6a6.png', '_blank', '测试友情链接', 1, 0, NULL, 0);
...
CREATE TABLE IF NOT EXISTS `menu` (
  ...
  KEY `model` (`model`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='后台菜单表' AUTO_INCREMENT=347 ;

--
-- 转存表中的数据 `menu`
--

INSERT INTO `menu` (`id`, `parentid`, `app`, `model`, `action`, `data`, `type`, `status`, `name`, `icon`, `remark`, `listorder`) VALUES
(1, 0, 'Admin', 'Content', 'default', '', 0, 1, '内容管理', 'file-o', '', 30),
...
(18, 1, 'Portal', 'AdminTerm', 'index', '', 0, 1, '分类列表', '', '', 2),
...
(23, 1, 'Portal', 'AdminTerm', 'add', '', 1, 1, '添加分类', '', '', 2),
...
(39, 0, 'Admin', 'Extension', 'default', '', 0, 1, '站点管理', 'desktop', '', 40),
...
(85, 0, 'Admin', 'Menu', 'default', '', 1, 1, '菜单管理', 'th-list', '', 20),
...
(109, 0, 'Admin', 'Setting', 'default', '', 0, 1, '设置', 'cog', '', 80),
(110, 109, 'Admin', 'Setting', 'userdefault', '', 0, 1, '个人信息', '', '', 0),
(111, 110, 'Admin', 'User', 'userinfo', '', 1, 1, '个人资料', '', '', 0),
...
(115, 39, 'Admin', 'Setting', 'site', '', 1, 1, '网站信息', '', '', 1),
...
(132, 0, 'User', 'Indexadmin', 'default', '', 1, 1, '用户管理', 'user', '', 10),
...
CREATE TABLE IF NOT EXISTS `nav_cat` (
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='全站配置表' AUTO_INCREMENT=10 ;
...
(6, 'site_options', '{"site_name":"\\u540e\\u53f0\\u7ba1\\u7406","site_icp":"","site_admin_email":"ceshukeji@gmail.com","site_tongji":"","site_copyright":"","site_seo_title":"\\u540e\\u53f0\\u7ba1\\u7406","site_seo_keywords":"\\u540e\\u53f0\\u7ba1\\u7406","site_seo_description":"\\u540e\\u53f0\\u7ba1\\u7406","urlmode":"2","html_suffix":"","comment_time_interval":"0"}', 1),
(9, 'upload_setting', '{"image":{"upload_max_filesize":"10240","extensions":"jpg,jpeg,png,gif,bmp"},"video":{"upload_max_filesize":"10240","extensions":"mp4,avi,wmv,rm,rmvb,mkv"},"audio":{"upload_max_filesize":"10240","extensions":"mp3,wma,wav"},"file":{"upload_max_filesize":"10240","extensions":"txt,pdf,doc,docx,xls,xlsx,ppt,pptx,zip,rar"}}', 1),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Portal文章表' AUTO_INCREMENT=3 ;

--
-- 转存表中的数据 `posts`
--

INSERT INTO `posts` (`id`, `post_author`, `post_keywords`, `post_source`, `post_date`, `post_content`, `post_title`, `post_excerpt`, `post_status`, `comment_status`, `post_modified`, `post_content_filtered`, `post_parent`, `post_type`, `post_mime_type`, `comment_count`, `smeta`, `post_hits`, `post_like`, `istop`, `recommended`) VALUES
(1, 1, '测试文章', '测试文章', '2016-11-01 23:53:55', '<p>测试文章内容</p>', '测试文章', '测试文章', 1, 1, '2016-11-01 23:54:32', NULL, 0, 1, '', 0, '{"thumb":"","template":""}', 0, 0, 0, 0),
(2, 1, '测试页面', NULL, '2016-11-01 23:58:07', '<p>测试页面内容</p>', '测试页面1', '测试页面', 1, 1, '2016-11-01 23:57:44', NULL, 0, 2, '', 0, '{"template":"page","thumb":""}', 0, 0, 0, 0);
...
INSERT INTO `role` (`id`, `name`, `pid`, `status`, `remark`, `create_time`, `update_time`, `listorder`) VALUES
...
INSERT INTO `slide` (`slide_id`, `slide_cid`, `slide_name`, `slide_pic`, `slide_url`, `slide_des`, `slide_content`, `slide_status`, `listorder`) VALUES
(1, 0, '测试幻灯片', 'admin/20161102/5818bc148eeb9.png', '', '测试幻灯片描述', '测试幻灯片内容', 1, 0);
...
CREATE TABLE IF NOT EXISTS `slide_cat` (
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Portal 文章分类对应表' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `term_relationships`
--

INSERT INTO `term_relationships` (`tid`, `object_id`, `term_id`, `listorder`, `status`) VALUES
(1, 1, 3, 0, 1);
...
CREATE TABLE IF NOT EXISTS `terms` (
  ...
  `status` int(2) NOT NULL DEFAULT '1' COMMENT '状态，1发布，0不发布',
  PRIMARY KEY (`term_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='Portal 文章分类表' AUTO_INCREMENT=4 ;

--
-- 转存表中的数据 `terms`
--

INSERT INTO `terms` (`term_id`, `name`, `slug`, `taxonomy`, `description`, `parent`, `count`, `path`, `seo_title`, `seo_keywords`, `seo_description`, `list_tpl`, `one_tpl`, `listorder`, `status`) VALUES
(3, '网站公告', '', 'article', '网站公告', 0, 0, '0-3', '网站公告', '网站公告', '网站公告', 'list', 'article', 0, 1);
...
INSERT INTO `users` (`id`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `avatar`, `sex`, `birthday`, `signature`, `last_login_ip`, `last_login_time`, `create_time`, `user_activation_key`, `user_status`, `score`, `user_type`, `coin`, `mobile`) VALUES
(1, 'admin', '###b412cdb0cfa5e5511a63d231a6af6a36', 'admin', 'ceshukeji@gmail.com', '', NULL, 0, '1995-01-17', '', '127.0.0.1', '2018-12-01 16:13:51', '2016-10-03 09:09:32', '', 1, 0, 1, 0, '');
